            ...
            <h2 className="font-extrabold mb-2 lg:mb-3">
              {isKo ? (
                <>
                  ...
                  <span className="block text-lg sm:text-xl md:text-3xl lg:text-[44px] xl:text-[52px] leading-[1.4] pb-3 bg-gradient-to-r from-amber-300 via-yellow-200 to-amber-300 bg-clip-text text-transparent">
                    우리 학교 맞춤 청소년 캠프
                  </span>
                </>
              ) : (
