...
export async function generateMetadata({
  ...
  void locale;
  return {
    title: '전문인 특강 | 4차산업혁명·기업가정신·스타트업 특강',
    description:
          ...
          <div className="max-w-[1170px] 2xl:max-w-[1280px] mx-auto px-4">
            ...
            <div className="text-center max-w-[900px] mx-auto mb-16">
              ...
              <p className="text-[15px] text-gray-600 leading-relaxed">
                ...
                <br />
                전문 강사의 특강을 통해 4차 산업혁명을 이해하고 4차 산업혁명 시대를 대표하는 미래
                기술들을 탐구할 수 있습니다.
                <br />
                    ...
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="py-4 px-4 text-gray-600 leading-relaxed">
                        <ul className="space-y-1">
                          ...
                          <li className="relative pl-4 before:content-['-'] before:absolute before:left-0">
                            학생, 학부모, 교사 대상 교육을 연계한 통합 프로그램이 필요한 학교
                          </li>
                          <li className="relative pl-4 before:content-['-'] before:absolute before:left-0">
                            진로 · 학습 · 인성 영역의 주요 이슈에 대해 단계적 프로그램을 고민하는
                            학교
                          </li>
                          <li className="relative pl-4 before:content-['-'] before:absolute before:left-0">
                            특강, 워크샵, 연수, 멘토링 등 다양한 방식의 연계 프로그램을 도입하려는
                            학교
                          </li>
                          <li className="relative pl-4 before:content-['-'] before:absolute before:left-0">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-t-2 border-[#336666] text-[14px]">
                  <tbody>
                    ...
                    <tr className="border-b border-gray-200">
                      <th className="py-4 px-4 bg-gray-50 text-left font-semibold text-gray-700 align-top">
                        전개
                      </th>
                      <td className="py-4 px-4 text-gray-600 leading-relaxed">
                        ...
                        <ul className="space-y-0.5">
                          <li className="relative pl-4 before:content-['-'] before:absolute before:left-0">
                            3D프린터, 인공지능, VR/AR과 같은 4차산업혁명 메인 기술 알아보기
                          </li>
                          <li className="relative pl-4 before:content-['-'] before:absolute before:left-0">
                            4차산업혁명시대 미래 예측하기
                          </li>
                    ...
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="py-4 px-4 text-gray-600 leading-relaxed">
                        ...
                        <ul className="space-y-0.5">
                          <li className="relative pl-4 before:content-['-'] before:absolute before:left-0">
                            4차산업혁명에 대비하는 개인과 기업의 자세 비교하기
                          </li>
                          <li className="relative pl-4 before:content-['-'] before:absolute before:left-0">
                            4차산업혁명에서 살아남기 위한 기업가정신 기르기
                          </li>
                        </ul>
                      </td>
                    </tr>
          ...
          <div className="max-w-[1170px] 2xl:max-w-[1280px] mx-auto px-4 h-full flex items-center">
            ...
            <div className="hidden md:block md:w-1/2">
              <ul className="flex flex-wrap gap-3 justify-end">
                {['청년 CEO의 창업스토리', '국내외창업시장을 노려라!', '생생 토크쇼'].map(
                  (item) => (
                    <li
                      key={item}
        ...
        <div className="py-16 bg-white">
          <div className="max-w-[1170px] 2xl:max-w-[1280px] mx-auto px-4">
            ...
            <div className="text-center max-w-[900px] mx-auto mb-16">
              ...
              <p className="text-[15px] text-gray-600 leading-relaxed">
                실제 벤처기업 청년 창업 성공사례 CEO의 마음을 움직이고 동기를 심어주는 특별한
                강연입니다.
                <br />
                국내외 창업시장에 관한 생생한 이야기와 창업 노하우 QnA 시간으로 학생 스스로가
                능동적으로 생각하며
                <br />
                ...
                <table className="w-full border-t-2 border-[#336666] text-[14px]">
                  <tbody>
                    ...
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="py-4 px-4 text-gray-600">
                        <span className="font-bold text-[#951015]">100-120분</span>
                      </td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <th className="py-4 px-4 bg-gray-50 text-left font-semibold text-gray-700">
        ...
        <div className="max-w-[1170px] 2xl:max-w-[1280px] mx-auto px-4">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 md:p-8">
            <ul className="space-y-3 text-[14px] text-gray-600 leading-relaxed">
              ...
              <li className="relative pl-4 before:content-[''] before:absolute before:left-0 before:top-[10px] before:w-[6px] before:h-[6px] before:bg-[#336666] before:rounded-full">
                프로그램 안내 문자(수업 일시, 주소)는 프로그램 기준 1-2일 전 오후 6시까지 체험 교육
                담당자에게 발송됩니다.
              </li>
              <li className="relative pl-4 before:content-[''] before:absolute before:left-0 before:top-[10px] before:w-[6px] before:h-[6px] before:bg-[#336666] before:rounded-full">
