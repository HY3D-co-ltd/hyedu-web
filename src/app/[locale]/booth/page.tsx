...
const features = [
  {
    image:
      '/images/programs/detail/maker_booth_operation/education_feature_1_technology_education.png',
    title: '기술직업 체험교육',
    description:
      '3D게임 캐릭터 디자이너, 드론조종사 등 4차산업혁명 기술을 이용한 미래 유망 직업을 탐색하고 기술 이해를 바탕으로 기업가 정신을 함양할 수 있도록 함',
  },
  {
    image: '/images/programs/detail/maker_booth_operation/education_feature_2_pbl_class.png',
    title: '사고력을 기르는 PBL 수업',
    description:
      '단순히 정답을 맞히는 것이 아니라 문제를 해결하는 역량을 키워나감과 동시에 자기주도적 학습을 바탕으로 생각하는 힘을 기를 수 있도록 하는 수업',
  },
  {
    image:
      '/images/programs/detail/maker_booth_operation/education_feature_3_collaborate_troubleshoot.png',
    title: '협동하며 문제해결',
    description:
      '혼자 해결할 수 없는 문제를 그룹학습을 통해 팀원들과의 정보공유 및 상호작용으로 해결할 수 있으며 이러한 과정을 통해 배려와 존중의 정신을 배울 수 있음',
  },
  {
    image:
      '/images/programs/detail/maker_booth_operation/education_feature_4_individual_portfolio.png',
    title: '개별 결과물과 포트폴리오',
    description:
      '캠프 내 모든 메이커 액티비티는 프로그램 활동을 통해 개별 결과물을 제작하고 참여 학생은 이를 제공받아 메이커 활동 포트폴리오를 만들 수 있음',
  },
];
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="md:w-1/2">
              <ul className="flex flex-wrap gap-3 justify-center md:justify-end">
                {['3D프린팅', '3D펜', 'VR/AR', '드론', '로봇 코딩', '자율주행자동차'].map(
                  (tag) => (
                    <li
                      key={tag}
        ...
        <div className="mx-auto max-w-[1170px] 2xl:max-w-[1280px]">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-xl md:text-2xl font-bold text-gray-900 mb-4">
              <span className="text-point">창의체험 부스 운영</span>은
            </p>
                    ...
                    <td className="px-4 py-3 text-gray-700">
                      <ul className="space-y-1">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-gray-400 mt-0.5">-</span>
                          <span>
                            관내 학교를 대상으로, 지역 특색에 맞는 통합 프로그램을 지원하려는
                            지자체나 교육청
                          </span>
                        </li>
                      </ul>
          ...
          <div className="max-w-2xl mx-auto">
            <table className="w-full border-collapse text-sm md:text-base">
              <tbody>
                ...
                <tr className="border-t border-gray-200">
                  <th className="bg-point text-white font-semibold px-4 py-4 text-center align-top">
                    전개
                  </th>
                  <td className="px-4 md:px-6 py-4 text-gray-700">
                    <p className="font-semibold text-gray-900 mb-2">
        ...
        <div className="mx-auto max-w-[1170px] 2xl:max-w-[1280px]">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2 flex items-center">
              <div>
                <h3 className="font-bold text-point text-lg mb-2">본사</h3>
            ...
            <ul className="space-y-4 text-sm md:text-base text-gray-700">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <br />
                  <span className="text-gray-500 text-sm">
                    ※ 프로그램 진행 인원이 20명 이하일 경우, 추가 요금이 발생할 수 있습니다.
                  </span>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-point flex-shrink-0 mt-2" />
                <span>
                  프로그램 안내 문자(수업 일시, 주소)는 프로그램 기준 1-2일 전 오후 6시까지 체험
                  교육 담당자에게 발송됩니다.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-point flex-shrink-0 mt-2" />
                <span>
                  수업 10분전까지 입장 부탁드리며, 늦을 경우 일부 프로그램 체험이 제한될 수
                  있습니다.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-point flex-shrink-0 mt-2" />
                <span>
                  체험 교육 당일, 사전 연락 없이 지각 및 불참하실 경우, 당일 불참으로 처리되며
                  취소/보충/환불이 불가합니다.
                </span>
              </li>
              <li className="flex items-start gap-3">
